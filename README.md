node-red-contrib-ui-grid
========================

Node-RED widget node for showing items grid.

![Example](figs/sample00.gif)
...
Run the following command in your Node-RED user directory - typically `~/.node-red`
        ...
        npm install node-red-contrib-ui-grid
...
`ui-grid` node is a UI widget that can be used to display list of items in Node-RED dashboard. 

Items array is passed by `msg.payload`.  It consists of json objects.
